...
#pragma omp parallel
  {
    ...
    // Ecriture dans un fichier texte par le thread maître c'est à dire
    // celui qui s'exécute sur le coeur ayant démarré l'application et donc
    // le numéro est toujours zéro.
#pragma omp master
